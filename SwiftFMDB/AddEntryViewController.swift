...
class AddEntryViewController : UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        nameLabel = UILabel(frame: CGRectMake(20, 60, 300, 40))
        nameLabel?.text = "Entry name:"
        self.view.addSubview(nameLabel!)
        
        nameTextField = UITextField(frame: CGRectMake(30, 100, 260, 40))
        ...
        descLabel = UILabel(frame: CGRectMake(20, 150, 300, 40))
        descLabel?.text = "Entry description:"
        self.view.addSubview(descLabel!)
        
        descTextField = UITextField(frame: CGRectMake(30, 190, 260, 40))
